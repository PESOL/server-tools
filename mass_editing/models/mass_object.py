...
class MassObject(models.Model):
    ...
    ref_ir_act_window_id = fields.Many2one('ir.actions.act_window',
                                           ...
                                           help="Sidebar action to make this "
                                                ...
                                                "document model.")
    ref_ir_default_id = fields.Many2one('ir.default', 'Sidebar button',
                                        readonly=True,
    ...
    def create_action(self):
        ...
        vals['ref_ir_default_id'] = self.env['ir.default'].sudo().create({
            'display_name': button_name,
            'field_id': self.field_ids.id,
            'json_value': "ir.actions.act_window," +
    ...
    def unlink_action(self):
        ...
        self.mapped('ref_ir_default_id').sudo().unlink()
        return True
